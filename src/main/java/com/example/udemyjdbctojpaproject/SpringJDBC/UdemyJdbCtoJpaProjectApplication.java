...
public class UdemyJdbCtoJpaProjectApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) { SpringApplication.run(UdemyJdbCtoJpaProjectApplication.class, args);}
